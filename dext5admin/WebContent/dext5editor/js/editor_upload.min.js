function uploadAjaxOnprogressStart(a,c){DEXTTOP.G_CURREDITOR.xhr_onprogress=new XMLHttpRequest;var b=DEXTTOP.G_CURREDITOR.xhr_onprogress;b.upload.onprogress=function(a){try{var b=DEXTTOP.DEXT5.util.parseIntOr0(a.loaded/a.total*100),c=document.getElementById("dext_loading");c&&c.childNodes&&(c.childNodes[1].nodeValue=" Uploading... "+b+"%")}catch(d){loading_image_show(!1)}};b.onload=function(){if(b){var a;a=200==b.status?b.responseText:"[FAIL]File Upload Error";b=null;loading_image_show(!1);c(a)}};
b.onerror=function(){b=null;loading_image_show(!1);c("[FAIL]File Upload Error")};var d=new FormData;a.formData&&0<a.formData.length&&a.formData.each(function(a,b){d.append(a,b)});a.fileObj&&d.append(a.fileID,a.fileObj[0]);b.open("POST",a.handlerUrl,!0);b.send(d)}function uploadAjaxOnprogressCancel(){if(DEXTTOP.G_CURREDITOR.xhr_onprogress)try{DEXTTOP.G_CURREDITOR.xhr_onprogress.abort(),DEXTTOP.G_CURREDITOR.xhr_onprogress=null}catch(a){}}
